...
<section class="d-flex align-items-center page-hero inner-page-hero " id="page-hero">
    ...
    <div class="row">
        ...
        <h1 class="hero-title" data-splitting>contact us</h1>
        <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay="1s">
            <li class="breadcrumb-item"><a class="breadcrumb-link" href="./"><i class="fas fa-home icon "></i>home</a></li>
...
<section class="contact-info mega-section">
    ...
    <div class="section-heading center-heading">
        <h2 class="section-title wow" data-splitting="words">Our Contact Info</h2>
        <p class="section-subtitle wow fadeInUp" data-wow-delay=".5s"></p>
    ...
    <div class="info-section ">
        ...
        <div class="col-12 col-lg-4 ">
            ...
            <div class="info-content">
                ...
                <p class="info-text">5 xyz st. elraml alexandria</p>
                <p class="info-text">
                10 abc st. elraml alexandria
        ...
        <div class="col-12 col-lg-4 ">
            <div class="info-panel wow fadeInUp" data-wow-delay=".4s"><i class="fas fa-phone icon"></i>
            <div class="info-content">
                <h6 class="info-title">phone numbers</h6>
                <p class="info-text"> <a class="tel link" href="tel:0123456789">(02) 0123456789</a><a class="tel link" href="tel:0123456789">(02) 9876543210</a></p>
            </div>
            </div>
        </div>
        <div class="col-12 col-lg-4 ">
            ...
            <div class="info-content">
                ...
                <p class="info-text"> <a class="tel link" href="mailto:info@example.com">info@example.com</a><a class="tel link" href="mailto:support@example.com">support@example.com</a></p>
            </div>
            </div>
        </div>
        </div>
    ...
    <div class="map-box">
        ...
        <div class="gmap_canvas">
            <iframe class="map-iframe" id="gmap_canvas" src="https://maps.google.com/maps?q=alexandria&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"></iframe>
        </div>
        </div>
    </div>
    </div>
...
<section class="contact-us  mega-section section-bg-shade" id="contact-us">
    <div class="container">
    <div class="section-heading center-heading">
        <h2 class="section-title wow" data-splitting="words">Leave your message</h2>
    ...
    <div class="row">
        ...
        <div class="main-form-wraper"> 
            <form class="main-form" id="contact-us-form" autocomplete="off">
                <div class="row ">
                    ...
                    <button class=" ma-btn-primary" id="submit-btn" type="submit" name="UserSubmit">Send your message
                    </button>
                    </div>
